...
mass_bins_forqcd = np.array([0., 10., 20., 30., 40., 45.0, 50.0, 55.0, 60.0, 65.0,
...
mass_bins_forqcd_output = np.array([40.0, 45.0, 50.0, 55.0, 60.0, 65.0,
                         70.0, 75.0, 80.0, 85.0, 90.0, 95.0, 100.0, 105.0, 110.0, 115.0, 120.0, 125.0, 130.0, 135.0, 140.])
...
Vptbins = np.array([0, 2.0, 4, 6, 8.0, 10.0, 14.0, 16.0, 20., 25.0, 30.0, 40.0, 50.0, 60.0, 70.0, 90.0, 110.0, 150.0, 200.0, 13000.0])
