...
if __name__  == "__main__":
    ...
    if do13TeV:
        ...
        for key, val in mass_bins_test.items():
            ...
            card_muplus, card_muminus, card_zmumu, card_xsec_muplus, card_xsec_muminus, card_xsec_mumu = RunPreparations(fwsig_input, fwsig_rebin, fwsig_mergeTau, fqcd_input, fqcd_rebin, fqcd_input_scaled, fqcd_rebin_scaled, fqcd_output, "mu", outdir_card = f"cards/test{key}", mass_bins = val, fzsig_input=fzsig_mumu_input, applyLFU=applyLFU)
