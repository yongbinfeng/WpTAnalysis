...
def main():
    ...
    def makeDraws(strname, ymax):
        ptbins = np.array([25.0, 30.0, 35.0, 45.0, 60.0])
        metbins = np.array([0, 10.0, 20.0, 30.0, 40.0, 50.0, 60.0])
        ...
        sampMan.cacheDraw2D("Lep_pt", "deltaPhi", f"histo_wjets_{lepname}_pt_vs_deltaPhi_{strname}", ptbins, phibins, DrawConfig(xmin=25, xmax=60, ymin=0, ymax=3.2, xlabel="Lepton p_{T} [GeV]", ylabel="#Delta#phi(#mu, MET)", zlabel="Events / bin", dology=False, donormalizebin=False, addOverflow=True, addUnderflow=True, showratio=False, legendPos=[0.94, 0.88, 0.70, 0.68]), weightname=strname)
        ...
        sampMan.cacheDraw2D("Lep_pt", "Lep_eta", f"histo_wjets_{lepname}_pt_vs_eta_{strname}_deltaPhiP", ptbins, etabins, DrawConfig(xmin=25, xmax=60, ymin=-2.4, ymax=2.4, xlabel="Lepton p_{T} [GeV]", ylabel="Lepton #eta", zlabel="Events / bin", dology=False, donormalizebin=False, addOverflow=True, addUnderflow=True, showratio=False, legendPos=[0.94, 0.88, 0.70, 0.68]), weightname=f"{strname}_deltaPhiP")
        sampMan.cacheDraw2D("Lep_pt", "met_pt", f"histo_wjets_{lepname}_pt_vs_met_{strname}_deltaPhiP", ptbins, metbins, DrawConfig(xmin=25, xmax=60, ymin=0, ymax=60, xlabel="Lepton p_{T} [GeV]", ylabel="MET [GeV]", zlabel="Events / bin", dology=False, donormalizebin=False, addOverflow=True, addUnderflow=True, showratio=False, legendPos=[0.94, 0.88, 0.70, 0.68]), weightname=f"{strname}_deltaPhiP")
        sampMan.cacheDraw2D("Lep_pt", "Lep_eta", f"histo_wjets_{lepname}_pt_vs_eta_{strname}_deltaPhiM", ptbins, etabins, DrawConfig(xmin=25, xmax=60, ymin=-2.4, ymax=2.4, xlabel="Lepton p_{T} [GeV]", ylabel="Lepton #eta", zlabel="Events / bin", dology=False, donormalizebin=False, addOverflow=True, addUnderflow=True, showratio=False, legendPos=[0.94, 0.88, 0.70, 0.68]), weightname=f"{strname}_deltaPhiM")
