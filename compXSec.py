...
def ThXSec2TGraph(xsecs, color = 4):
    n = len(xsecs)
...
gZ_ppbar = ThXSec2TGraph(xsecs['ppbar']['Z'])
gW_ppbar = ThXSec2TGraph(xsecs['ppbar']['Winc'])

gZ_pp = ThXSec2TGraph(xsecs['pp']['Z'])
gWp_pp = ThXSec2TGraph(xsecs['pp']['Wp'])
gWm_pp = ThXSec2TGraph(xsecs['pp']['Wm'])
gW_pp = ThXSec2TGraph(xsecs['pp']['Winc'])
